...
// Development-friendly analytics service. Attempts real API first,
// falls back to lightweight mock data when the backend is unreachable.
const analyticsService = {
    ...
    getDLPredictionsSummary: async () => {
        try {
            ...
            console.warn('analyticsService: failed to fetch real API, returning mock data', err?.message || err);
