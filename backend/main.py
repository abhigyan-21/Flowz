...
from app.routers import predictions, simulation, alerts, history, timeseries, config, dl_predictions, evacuation, arcgis
...
app.include_router(arcgis.router, prefix="/api", tags=["ArcGIS Integration"])
